                ...
                <figure>
                    ...
                    <figcaption class="p-4">
                        ...
                        <small class="leading-5 text-gray-500 dark:text-gray-400">
                            Un día decidimos crear una aplicación web que permitiese a los usuarios agendar sus citas médicas usando tanto su computadora como su teléfono.
                        ...
                        <p>
                            <small class="leading-5 text-gray-500 dark:text-gray-400">
                               El paciente entonces escogería la fecha y hora que desea ser atendido y el médico le confirma su solicitud.
                            </small>
                        </p>
                    </figcaption>
                </figure>
        ...
        <a _href="link" class="cursor-pointer">
            <figure>
                ...
                <figcaption class="p-4">
                    ...
                    <!-- Description -->
                    <small class="leading-5 text-gray-500 dark:text-gray-400">
                        Estamos comenzando pero ya tenemos instrumentada gran parte de las funcionalidades de la aplicación.
                    </small>
                    <small class="leading-5 text-gray-500 dark:text-gray-400">
