<div class="py-8">
    <section class="w-full max-w-5xl mx-auto bg-gray-100 text-gray-600 h-screen px-4 py-8">
        <header class="px-5 py-4 border-b border-gray-100">
            <h2 class="font-bold text-center text-gray-800 capitalize text-2xl mb-2">{{ __('symptoms') }}</h2>
        </header>
        <div class="flex items-center bg-white p-3">
            <input class="w-full rounded" type="text" placeholder="{{ __('search symptom') }}" wire:model="search" />
                    ...
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap" width="15%">
                            <div class="flex justify-around items-center">
                                <a class="text-green-500 cursor-pointer" wire:click="edit({{ $symptom->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <a class="text-red-500 cursor-pointer" wire:click="delete({{ $symptom->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <x-slot name="content">
            <div class="grid grid-cols-1 gap-6">
                <div class="seleccionadas">
                    <div>
                        <input class="w-full rounded" type="text" placeholder="{{ __('symptom') }}"
                            wire:model="name" />
