    ...
    <div class="w-full col-span-4" id="datos-de-enfermedades">
        <div class="card">
            <div class="card-body text-gray-500 flex justify-between items-center">
                <h1 class="font-bold text-2xl">{{ __('surgery history') }}</h1>
                            ...
                            <div class="overflow-x-auto">
                                <table class="table-auto w-full">
                                    <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                                        <tr>
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-left">{{ __('surgery') }}</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
                                    ...
                                    <tbody class="text-sm divide-y divide-gray-100">
                                        @forelse($patient_surgeries as $item)
                                            <tr>
                                                ...
                                                <td width="10%" class="p-2 whitespace-nowrap">
                                                    <div>
                                                        <div class="text-left">{{ $item->pivot->type }}</div>
                                                    </div>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4">
                                                    <h1 class="text-center text-gray-600 text-2xl">no hay cirugías
                                                        registrada</h1>
                                                </td>
                                            </tr>
                                        @endforelse
